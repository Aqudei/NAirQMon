...
Namespace Migrations
    ...
    Public NotInheritable Partial Class addedcompleteaccount
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(addedcompleteaccount))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "201703010037302_added complete account"
            End Get
        End Property

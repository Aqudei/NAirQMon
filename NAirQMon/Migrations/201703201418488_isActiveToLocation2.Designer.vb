...
Namespace Migrations
    ...
    Public NotInheritable Partial Class isActiveToLocation2
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(isActiveToLocation2))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "201703201418488_isActiveToLocation2"
            End Get
        End Property

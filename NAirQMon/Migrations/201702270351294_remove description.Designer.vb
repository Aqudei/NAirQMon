...
Namespace Migrations
    ...
    Public NotInheritable Partial Class removedescription
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(removedescription))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "201702270351294_remove description"
            End Get
        End Property

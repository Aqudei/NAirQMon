...
Namespace Migrations
    ...
    Public NotInheritable Partial Class isActiveToLocation
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(isActiveToLocation))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "201703201417427_isActiveToLocation"
            End Get
        End Property

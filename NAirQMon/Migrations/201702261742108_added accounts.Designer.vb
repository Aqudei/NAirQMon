...
Namespace Migrations
    ...
    Public NotInheritable Partial Class addedaccounts
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(addedaccounts))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "201702261742108_added accounts"
            End Get
        End Property

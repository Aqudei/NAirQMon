...
Namespace Migrations
    ...
    Public NotInheritable Partial Class addeduseraccounts
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(addeduseraccounts))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "201702272203392_added user accounts"
            End Get
        End Property

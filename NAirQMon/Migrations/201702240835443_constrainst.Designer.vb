...
Namespace Migrations
    ...
    Public NotInheritable Partial Class constrainst
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(constrainst))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "201702240835443_constrainst"
            End Get
        End Property

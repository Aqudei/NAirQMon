...
Namespace Migrations
    ...
    Public NotInheritable Partial Class fixmiddletomiddleName
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(fixmiddletomiddleName))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "201703010039161_fix middle to middleName"
            End Get
        End Property

...
Namespace Migrations
    ...
    Public NotInheritable Partial Class addeddescription
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(addeddescription))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "201702270350337_added description"
            End Get
        End Property

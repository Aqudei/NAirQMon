...
Namespace Migrations
    ...
    Public NotInheritable Partial Class removelocationlabel
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(removelocationlabel))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "201702270410550_remove location-label"
            End Get
        End Property
